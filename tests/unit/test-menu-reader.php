...
final class Test_Menu_Reader extends TestCase {
	...
	private function core(): Menu_Reader {
		return new Menu_Reader( amorg_fixture_core_menu(), amorg_fixture_core_submenu() );
	}
	...
	private function production(): Menu_Reader {
		return new Menu_Reader( amorg_fixture_production_menu(), amorg_fixture_core_submenu() );
	}
	...
	public function test_malformed_entries_are_survived(): void {
		$reader = new Menu_Reader( amorg_fixture_malformed_menu() );
