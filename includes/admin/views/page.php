...
if ( Capabilities::current_user_can_manage() ) {
	$amorg_tabs['layout']   = __( 'Layout', 'archinest-sidebar-categories' );
	$amorg_tabs['groups']   = __( 'Groups', 'archinest-sidebar-categories' );
	$amorg_tabs['roles']    = __( 'Roles', 'archinest-sidebar-categories' );
	$amorg_tabs['advanced'] = __( 'Advanced', 'archinest-sidebar-categories' );
}

if ( Capabilities::current_user_can_personalise() ) {
	$amorg_tabs['personal'] = __( 'Personalise my menu', 'archinest-sidebar-categories' );
}
?>
<div class="wrap amorg-settings">
	<h1><?php echo esc_html__( 'Sidebar Categories', 'archinest-sidebar-categories' ); ?></h1>
	...
	<nav class="nav-tab-wrapper wp-clearfix" aria-label="<?php echo esc_attr__( 'Sidebar Categories sections', 'archinest-sidebar-categories' ); ?>">
