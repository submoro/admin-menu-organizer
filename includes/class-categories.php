...
final class Categories {
	...
	public static function definitions(): array {
		...
		$bundled = require MOCAM_PLUGIN_DIR . 'includes/data/categories.php';
		$labels  = self::labels();
		 ...
		 */
		$filtered = apply_filters( 'mocam_category_definitions', $defaults );
	 ...
	 * mocam_category_definitions filter after the definitions were first read.
	 *
	 * @since 1.0.0
	 *
	 * @return void
	...
	private static function labels(): array {
		return array(
			'dashboard'    => __( 'Dashboard', 'menu-organizer-collapsible-admin-menu' ),
			'content'      => __( 'Content', 'menu-organizer-collapsible-admin-menu' ),
			'commerce'     => __( 'Commerce', 'menu-organizer-collapsible-admin-menu' ),
			'design'       => __( 'Design & Layout', 'menu-organizer-collapsible-admin-menu' ),
			'seo'          => __( 'SEO & Marketing', 'menu-organizer-collapsible-admin-menu' ),
			'security'     => __( 'Security & Backup', 'menu-organizer-collapsible-admin-menu' ),
			'performance'  => __( 'Performance', 'menu-organizer-collapsible-admin-menu' ),
			'users'        => __( 'Users & Access', 'menu-organizer-collapsible-admin-menu' ),
			'integrations' => __( 'Integrations', 'menu-organizer-collapsible-admin-menu' ),
			'tools'        => __( 'Tools & System', 'menu-organizer-collapsible-admin-menu' ),
			'ungrouped'    => __( 'Other', 'menu-organizer-collapsible-admin-menu' ),
		);
	}
