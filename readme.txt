...
Sidebar Categories groups those items into named, collapsible categories inside the sidebar you already have. It sorts what it recognises automatically, and lets you rearrange everything else by dragging it.
...
4. To change anything, go to **Settings > Sidebar Categories**.
